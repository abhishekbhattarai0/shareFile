...
interface CustomTextProps {
    variant?: Variant;
    fontFamily?: "Okra-Bold" | "Okra-Regualr" | "Okra-Black" | "Okra-Light" | "Okra-Medium";
    fontSize?: number;
    color?: string;
...
const CustomText: FC<CustomTextProps> = ({
    ...
    return (
        <Text
            onLayout={onLayout}
            style={[styles.text, { color: color || Colors.text, fontSize: computedFontSize }, style]}
