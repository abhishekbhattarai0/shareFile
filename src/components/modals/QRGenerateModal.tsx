import { View, Text, Modal, ActivityIndicator, Touchable, TouchableOpacity } from 'react-native'
...
const QRGenerateModal: FC<ModalProps> = ({ visible, onClose }) => {
    ...
    const [qrValue, setQrValue] = useState('Abhi')
                ...
                <View style={modalStyles.qrContainer}>
                    {
                        loading && qrValue === null || qrValue === '' ? (
                            <>
                                <View><Text>{`${qrValue} ${loading}`}</Text></View>
