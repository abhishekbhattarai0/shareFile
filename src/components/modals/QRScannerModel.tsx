import { View, Text, Modal, ActivityIndicator, Touchable, TouchableOpacity, Image } from 'react-native'
...
const QRScannerModel: FC<ModalProps> = ({ visible, onClose }) => {
    ...
    useEffect(() => {
        const checkPermisson = async () => {
            const cameraPermisson = await Camera.requestCameraPermission();
            setHasPermisson(cameraPermisson === 'granted')
        }
        ...
        >
            <View style={modalStyles.modalContainer}>
                ...
                <View style={modalStyles.info}>
                    ...
                    >
                        Ask the sender to show QR code to connect and transfer files.
                    </CustomText>
                </View>
